...
export const u8 = (value: number): LeoU8 => {
    ...
    if (value < 0 || value > ((1 << 8) - 1)) throw new Error('Exceed max uint8 value: ' + value);
...
export const u16 = (value: number): LeoU16 => {
    ...
    if (value < 0 || value > ((1 << 16) - 1)) throw new Error('Exceed max uint16 value: ' + value);
...
export const u32 = (value: number): LeoU32 => {
    ...
    if (value < 0 || value > ((1 << 32) - 1)) throw new Error('Exceed max uint32 value: ' + value);
